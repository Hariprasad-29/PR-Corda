...
public class ContractTests {
    ...
    public void issuerAndRecipientCannotHaveSameEmail() {
        CustomTokenState tokenPass = new CustomTokenState("Corda Number 1!",Operator.getParty(),0,new UniqueIdentifier());
        CustomTokenState tokenfail = new CustomTokenState("Corda Number 1!",Operator.getParty(),0,new UniqueIdentifier());
